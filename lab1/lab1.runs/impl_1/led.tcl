...
set rc [catch {
  ...
  set_property ip_repo_paths f:/learnzynq/lab1/lab1.cache/ip [current_project]
  set_property ip_output_repo f:/learnzynq/lab1/lab1.cache/ip [current_project]
  add_files -quiet F:/learnzynq/lab1/lab1.runs/synth_1/led.dcp
